...
import (
	...
	"git.jetbrains.space/orbi/fcsd/timesheet/internal/domain/impl"
	"git.jetbrains.space/orbi/fcsd/timesheet/internal/grpc"
	"git.jetbrains.space/orbi/fcsd/timesheet/internal/logger"
	"git.jetbrains.space/orbi/fcsd/timesheet/internal/meta"
	"git.jetbrains.space/orbi/fcsd/timesheet/internal/repository/storage"
)
...
func New() service.Service {
	...
	s.activityService = impl.NewTimesheetService(s.storageAdapterA, s.storageAdapterT)
